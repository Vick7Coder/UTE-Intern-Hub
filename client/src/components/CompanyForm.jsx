...
const CompanyForm = ({ open, setOpen, currentCompanyData }) => {
  ...
  useEffect(() => {
    if (currentCompanyData) {
      setValue("name", currentCompanyData.name);
      setValue("location", currentCompanyData.location);
      setValue("contact", currentCompanyData.contact);
      setValue("about", currentCompanyData.about);
    }
  }, [currentCompanyData, setValue]);
  ...
  const onSubmit = async (data) => {
    ...
    const updatedData = {
      ...data,
      profileUrl: logoURL || currentCompanyData.profileUrl
    };
