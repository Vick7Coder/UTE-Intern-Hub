        ...
        <div style={{ boxShadow: "0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
          ...
          <div className="pr-4 h-[474px]" style={{ minWidth: '100%', display: 'table' }}>
            ...
            <div className="flex gap-3 my-4 text-gray-600 text-sm flex-1">
              ...
              <p className="leading-relaxed"><span className="block font-bold text-gray-700">AI </span>Sorry, I couldn't find any information in the documentation about that. Expect answer to be less accurate I could not find the answer to this in the verified sources.</p>
            </div>
          </div>
